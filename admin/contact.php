...
$kontak = query("SELECT*FROM tb_kontak");
...
<head>
    ...
    <title>JajanTip || Admin - Contact</title>
</head>
                ...
                <div class="table-responsive" style="height: 393px; overflow-y:auto;">
                    ...
                    <table class="table table-dark table-striped table-hover table-bordered">
                        ...
                        <tr class="text-center align-middle" style="position: sticky; top: 0; z-index: 1;">
                            ...
                            <th scope="col" class="col-5">Pesan</th>
                        ...
                        <?php foreach ($kontak as $kon) { ?>
                            <tr class="text-center align-middle">
                                ...
                                <td><?php echo $kon["nama_kontak"]; ?></td>
                                <td><?php echo $kon["email_kontak"]; ?></td>
                                <td><?php echo $kon["pesan"]; ?></td>
                                <td><?php echo $kon["status_pesan"]; ?></td>
                                <td>
                                    <a href="ubhstatuskontak.php?id_kontak=<?= $kon['id_kontak']; ?>" class="btn btn-warning">Ubah Status</a>
                                    <a href="hpskontak.php?id_kontak=<?= $kon['id_kontak']; ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                            <?php $i++; ?>
