...
$pengguna = query("SELECT*FROM tb_pengguna");
...
<head>
    ...
    <title>JajanTip || Admin - Pengguna</title>
</head>
    ...
    <div class="container" style="margin-top:57px;">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Mulai Tambah Pengguna & Pencarian Kontak -->
                <div class="row">

                    <!-- Mulai Tambah Pengguna -->
                    <div class="col-md-6">
                        <a href="register.php" class="btn btn-primary">Tambah Pengguna</a>
                    </div>
                    <!-- Akhir Tambah Pengguna -->
                ...
                <!-- Akhir Tambah Pengguna & Pencarian Kontak -->
                    ...
                    <table class="table table-dark table-striped table-hover table-bordered">
                        ...
                        <?php foreach ($pengguna as $pgn) { ?>
                            <tr class="text-center align-middle">
                                ...
                                <td>
                                    <a href="ubhprofilpengguna.php?id_pengguna=<?= $pgn['id_pengguna']; ?>" class="btn btn-warning">Ubah Profil</a>
                                    <a href="hpsprofilpengguna.php?id_pengguna=<?= $pgn['id_pengguna']; ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                            <?php $i++; ?>
